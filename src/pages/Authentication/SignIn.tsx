...
const SignIn: React.FC = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
      ...
      try {
          const response = await axios.post('https://currencyexchangesoftware.eu/pilot/api/userlogin/checklogin', {
              userName,
              password,
              clientID : "1",
              branchID : "2",
          ...
          if (data.response && data.responseCode === "00") {
              ...
              localStorage.setItem('userName', data.data.userName);  // Store user information
...
<div className=' xl:mt-0 md:mt-5 md:mb-0'>
<div className="rounded-sm  container  border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark" style={{margin: '0 auto'}}>
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-6">
                  ...
                  {error && <div className="text-danger mt-3 p-2 bg-red-100 rounded-md">{error}</div>}
                </div>
